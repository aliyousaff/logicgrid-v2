                        ...
                        <div className="bg-muted/30 border border-border rounded-2xl p-8">
                            ...
                            <div className="space-y-8 relative">
                                ...
                                <div className="relative flex gap-6">
                                    <div className="w-8 h-8 rounded-full bg-background border border-border flex items-center justify-center text-xs font-bold text-violet-600 dark:text-violet-500 z-10 shrink-0 shadow-sm">
                                        01
                                    </div>
                                    <div>
                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input id="name" placeholder="Full Name" className="bg-muted/50 border-border h-12 text-foreground placeholder:text-muted-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500" />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="website" className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Business</label>
                                    <Input id="website" type="text" placeholder="Website (Optional)" className="bg-muted/50 border-border h-12 text-foreground placeholder:text-muted-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500" />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input id="email" type="email" placeholder="work@company.com" className="bg-muted/50 border-border h-12 text-foreground placeholder:text-muted-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500" />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="phone" className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Phone</label>
                                    <Input id="phone" type="tel" placeholder="+1..." className="bg-muted/50 border-border h-12 text-foreground placeholder:text-muted-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500" />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <select id="service" className="w-full bg-muted/50 border border-border rounded-md h-12 px-3 text-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500 appearance-none text-sm font-medium">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="outcome" placeholder="e.g. More leads, less admin, better data..." className="bg-muted/50 border-border h-12 text-foreground placeholder:text-muted-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500" />
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="notes" className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Project Details</label>
                                <Textarea id="notes" placeholder="Tell us about the project..." className="bg-muted/50 border-border min-h-[140px] text-foreground placeholder:text-muted-foreground focus:border-violet-500 focus:ring-1 focus:ring-violet-500 resize-none p-4" />
                            </div>
